...
const en = {
  ...
  home: {
    ...
    numbers: { orgs: "companies & institutions", robots: "robot models, hands-on", days: "longest unattended lab run", daysUnit: "days", roles: "roles in 3 countries" },
...
const de: Dict = {
  ...
  home: {
    ...
    numbers: { orgs: "Unternehmen & Institutionen", robots: "Robotermodelle im Einsatz", days: "längster unbeaufsichtigter Laborlauf", daysUnit: "Tage", roles: "Stationen in 3 Ländern" },
...
const tr: Dict = {
  ...
  home: {
    ...
    numbers: { orgs: "şirket ve kurum", robots: "üzerinde çalıştığım robot modeli", days: "en uzun gözetimsiz laboratuvar çalışması", daysUnit: "gün", roles: "pozisyon, 3 ülkede" },
